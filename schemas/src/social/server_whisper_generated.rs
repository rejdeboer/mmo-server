...
impl<'a> ServerWhisper<'a> {
    ...
    pub fn sender_name(&self) -> &'a str {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ServerWhisper::VT_SENDER_NAME, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn sender_id(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(ServerWhisper::VT_SENDER_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn recipient_name(&self) -> &'a str {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ServerWhisper::VT_RECIPIENT_NAME, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn recipient_id(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(ServerWhisper::VT_RECIPIENT_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn text(&self) -> &'a str {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ServerWhisper::VT_TEXT, None)
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ServerWhisperBuilder<'a, 'b, A> {
    ...
    pub fn add_sender_id(&mut self, sender_id: i32) {
        self.fbb_
            .push_slot::<i32>(ServerWhisper::VT_SENDER_ID, sender_id, 0);
    }
    #[inline]
    pub fn add_recipient_name(&mut self, recipient_name: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ServerWhisper::VT_RECIPIENT_NAME,
            recipient_name,
        );
    }
    #[inline]
    pub fn add_recipient_id(&mut self, recipient_id: i32) {
        self.fbb_
            .push_slot::<i32>(ServerWhisper::VT_RECIPIENT_ID, recipient_id, 0);
    }
    #[inline]
    pub fn add_text(&mut self, text: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ServerWhisper::VT_TEXT, text);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> ServerWhisperBuilder<'a, 'b, A> {
    ...
    pub fn finish(self) -> flatbuffers::WIPOffset<ServerWhisper<'a>> {
        ...
        self.fbb_
            .required(o, ServerWhisper::VT_SENDER_NAME, "sender_name");
        self.fbb_
            .required(o, ServerWhisper::VT_RECIPIENT_NAME, "recipient_name");
