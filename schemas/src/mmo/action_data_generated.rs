...
pub const ENUM_MAX_ACTION_DATA: u8 = 1;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ACTION_DATA: [ActionData; 2] =
    [ActionData::NONE, ActionData::PlayerMoveAction];
...
impl ActionData {
    ...
    pub const PlayerMoveAction: Self = Self(1);

    pub const ENUM_MIN: u8 = 0;
    pub const ENUM_MAX: u8 = 1;
    pub const ENUM_VALUES: &'static [Self] = &[Self::NONE, Self::PlayerMoveAction];
