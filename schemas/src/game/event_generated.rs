    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_union::<EventData, _>(
                ...
                true,
                |key, v, pos| match key {
                    EventData::EntityMoveEvent => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<EntityMoveEvent>>(
                            "EventData::EntityMoveEvent",
                            pos,
                        ),
                    EventData::EntitySpawnEvent => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<EntitySpawnEvent>>(
                            "EventData::EntitySpawnEvent",
                            pos,
                        ),
                    EventData::EntityDespawnEvent => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<EntityDespawnEvent>>(
                            "EventData::EntityDespawnEvent",
                            pos,
                        ),
                    EventData::game_ServerChatMessage => v
...
impl core::fmt::Debug for Event<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        match self.data_type() {
            ...
            EventData::game_ServerChatMessage => {
                if let Some(x) = self.data_as_game_server_chat_message() {
                    ds.field("data", &x)
                } else {
                    ds.field(
                        "data",
