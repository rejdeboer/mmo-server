...
impl<'a> EntityMoveEvent<'a> {
    ...
    pub fn entity_id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(EntityMoveEvent::VT_ENTITY_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn transform(&self) -> Option<&'a Transform> {
        ...
        unsafe {
            self._tab
                .get::<Transform>(EntityMoveEvent::VT_TRANSFORM, None)
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EntityMoveEventBuilder<'a, 'b, A> {
    ...
    pub fn add_entity_id(&mut self, entity_id: u64) {
        self.fbb_
            .push_slot::<u64>(EntityMoveEvent::VT_ENTITY_ID, entity_id, 0);
    }
    #[inline]
    pub fn add_transform(&mut self, transform: &Transform) {
        self.fbb_
            .push_slot_always::<&Transform>(EntityMoveEvent::VT_TRANSFORM, transform);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> EntityMoveEventBuilder<'a, 'b, A> {
