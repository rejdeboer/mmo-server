...
impl<'a> flatbuffers::Follow<'a> for Vitals {
  ...
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a Vitals>::follow(buf, loc) }
  }
}
impl<'a> flatbuffers::Follow<'a> for &'a Vitals {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { flatbuffers::follow_cast_ref::<Vitals>(buf, loc) }
  }
}
impl<'b> flatbuffers::Push for Vitals {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Vitals as *const u8, <Self as flatbuffers::Push>::size()) };
