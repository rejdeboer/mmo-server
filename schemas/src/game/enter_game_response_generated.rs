...
impl<'a> EnterGameResponse<'a> {
  pub const VT_PLAYER_ENTITY: flatbuffers::VOffsetT = 4;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.player_entity { builder.add_player_entity(x); }
    builder.finish()
  }


  #[inline]
  pub fn player_entity(&self) -> Option<Entity<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Entity>>(EnterGameResponse::VT_PLAYER_ENTITY, None)}
  }
}
...
impl flatbuffers::Verifiable for EnterGameResponse<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<Entity>>("player_entity", Self::VT_PLAYER_ENTITY, false)?
     .finish();
    Ok(())
  }
}
pub struct EnterGameResponseArgs<'a> {
    pub player_entity: Option<flatbuffers::WIPOffset<Entity<'a>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EnterGameResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_player_entity(&mut self, player_entity: flatbuffers::WIPOffset<Entity<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Entity>>(EnterGameResponse::VT_PLAYER_ENTITY, player_entity);
  }
  #[inline]
...
impl core::fmt::Debug for EnterGameResponse<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("EnterGameResponse");
      ds.field("player_entity", &self.player_entity());
      ds.finish()
  }
}
#[inline]
...
pub unsafe fn root_as_enter_game_response_unchecked(buf: &[u8]) -> EnterGameResponse {
  unsafe { flatbuffers::root_unchecked::<EnterGameResponse>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_enter_game_response_unchecked(buf: &[u8]) -> EnterGameResponse {
  unsafe { flatbuffers::size_prefixed_root_unchecked::<EnterGameResponse>(buf) }
}
#[inline]
