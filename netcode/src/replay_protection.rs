...
impl ReplayProtection {
    pub fn new() -> Self {
        Self {
            ...
            received_packet: [EMPTY; REPLAY_BUFFER_SIZE],
        }
    }
...
mod tests {
    ...
    fn replay_protection() {
        ...
        let max_sequence = (REPLAY_BUFFER_SIZE * 4) as u64;
        ...
        assert!(!replay_protection.already_received(max_sequence + REPLAY_BUFFER_SIZE as u64));
