...
impl ChannelPacket {
    pub fn sequence(&self) -> u64 {
        match self {
            ChannelPacket::SmallReliable { sequence, .. }
            | ChannelPacket::SmallUnreliable { sequence, .. }
            | ChannelPacket::UnreliableSlice { sequence, .. }
            | ChannelPacket::ReliableSlice { sequence, .. }
            | ChannelPacket::Ack { sequence, .. } => *sequence,
        }
    }
    ...
    pub fn from_bytes(b: &mut octets::Octets) -> Result<ChannelPacket, SerializationError> {
        ...
        match packet_type {
            0 => {
                ...
                Ok(ChannelPacket::SmallReliable {
                    sequence,
                    channel_id,
                    messages,
                })
            ...
            1 => {
                ...
                Ok(ChannelPacket::SmallUnreliable {
                    sequence,
                    channel_id,
                    messages,
                })
            ...
            2 => {
                ...
                Ok(ChannelPacket::ReliableSlice {
                    sequence,
                    channel_id,
                    slice,
                })
            ...
            3 => {
                ...
                Ok(ChannelPacket::UnreliableSlice {
                    sequence,
                    channel_id,
                    slice,
                })
...
mod tests {
    ...
    fn serialize_small_reliable_packet() {
        ...
        let packet = ChannelPacket::SmallReliable {
            sequence: 0,
            channel_id: 0,
            messages: vec![
                (0, vec![0, 0, 0].into()),
        ...
        let recv_packet = ChannelPacket::from_bytes(&mut b).unwrap();
    ...
    fn serialize_small_unreliable_packet() {
        let mut buffer = [0u8; 1300];
        let packet = ChannelPacket::SmallUnreliable {
            sequence: 0,
            channel_id: 0,
            messages: vec![
                vec![0, 0, 0].into(),
    ...
    fn serialize_reliable_slice_packet() {
        ...
        let packet = ChannelPacket::ReliableSlice {
            sequence: 0,
            channel_id: 0,
            slice: Slice {
                message_id: 0,
    ...
    fn serialize_unreliable_slice_packet() {
        ...
        let packet = ChannelPacket::UnreliableSlice {
            sequence: 0,
            channel_id: 0,
            slice: Slice {
                message_id: 0,
